	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$v->role_permission_ids}}</td>
				<td>{{$v->role_permission_ac}}</td>
				<td>{{$v->created_at}}</td>
				<td class="td-manage"><a title="编辑" href="javascript:;" onclick="admin_edit('角色编辑','/admin/role/xiugai/<?php echo $v->role_id; ?>','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'<?php echo $v->mg_id ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			@endforeach
		</tbody>
	</table>
