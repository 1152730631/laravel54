				...
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover">
						...
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="#">切换账户</a></li>
							<li><a href="/admin/manager/logout" onclick="if(!confirm('确定要退出系统么？')){return false}">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		@foreach($permissionA as $v)
			<dl id="menu-article">
				<dt><i class="Hui-iconfont">&#xe616;</i> {{$v->ps_name}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
						@foreach($permissionB as $vv)
								<!--显示一级权限本身对应的二级权限-->
						@if($vv->ps_pid == $v->ps_id)
							<li><a data-href="{{url($vv->address)}}" data-title="{{$vv->ps_name}}" href="javascript:void(0)">{{$vv->ps_name}}</a></li>
						@endif
						@endforeach
					</ul>
				</dd>
