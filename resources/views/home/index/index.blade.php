...
<head>
    ...
    <link rel="icon" href="http://localhost:8888/laravel54/Public/home/img/asset-favicon.ico">
    <title>在线教育网</title>

    <link rel="stylesheet" href="http://localhost:8888/laravel54/Public/home/plugins/normalize-css/normalize.css" />
    <link rel="stylesheet" href="http://localhost:8888/laravel54/Public/home/plugins/bootstrap/dist/css/bootstrap.css" />
    <link rel="stylesheet" href="http://localhost:8888/laravel54/Public/home/css/page-learing-index.css" />
</head>
...
<body data-spy="scroll" data-target="#myNavbar" data-offset="150">
    ...
    <header>
        <div class=" learingHeader">
            <nav class="navbar container">
                <div class="navbar-left"><img src="http://localhost:8888/laravel54/Public/home/img/asset-logoIco.png" alt=""></div>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="http://localhost:8888/laravel54/Public/home/img/widget-bannerA.jpg" alt="AA">
                </div>
                <div class="item">
                    <img src="http://localhost:8888/laravel54/Public/home/img/widget-bannerB.jpg" alt="">
                </div>
            </div>
                ...
                <div class="container cont-list">
                    <div class="cont-list-roll">
                        ...
                        <div class="cont-list-box">
                            <li class="">
                                <img src="http://localhost:8888/laravel54/Public/home/img/page-1.jpg" alt="AA">
                                <div class="tit">程序设计语言 <span>高</span></div>
                                <div>武汉大学</div>
                                <div>1门课程</div>
                            </li>
                            <li class="">
                                <img src="http://localhost:8888/laravel54/Public/home/img/widget-2.jpg" alt="AA">
                                <div class="tit">程序设计语言 <span>高</span></div>
                                <div>武汉大学</div>
                                <div>1门课程</div>
                            </li>
                            <li class="">
                                <img src="http://localhost:8888/laravel54/Public/home/img/widget-3.jpg" alt="AA">
                                <div class="tit">程序设计语言 <span>高</span></div>
                                <div>武汉大学</div>
                                <div>1门课程</div>
                            </li>
                            <li class="">
                                <img src="http://localhost:8888/laravel54/Public/home/img/widget-4.png" alt="AA">
                                <div class="tit">程序设计语言 <span>高</span></div>
                                <div>武汉大学</div>
                                <div>1门课程</div>
                            </li>
                            <li class="">
                                <img src="http://localhost:8888/laravel54/Public/home/img/widget-5.png" alt="AA">
                                <div class="tit">程序设计语言 <span>高</span></div>
                                <div>武汉大学</div>
                                <div>1门课程</div>
                            </li>
    ...
    <div class="index-cont-nav">
        <div id="myNavbar" class="collapse navbar-collapse ">
            <div id="myCollapse" class="collapse navbar-collapse">
                <div class="logo-ico"><img src="http://localhost:8888/laravel54/Public/home/img/asset-logoIco.png" alt=""></div>
                <ul class="nav navbar-nav">
    ...
    <div class="container">
        <div class="index-bot-video text-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="http://localhost:8888/laravel54/Public/home/img/widget-video.jpg" width="500" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div>
                        <!--<h1 style="display: inline-block">学成网</h1>--><img src="http://localhost:8888/laravel54/Public/home/img/asset-logoIco.png" alt=""></div>
    ...
    <script type="text/javascript" src="http://localhost:8888/laravel54/Public/home/plugins/jquery/dist/jquery.js"></script>
    <script type="text/javascript" src="http://localhost:8888/laravel54/Public/home/plugins/bootstrap/dist/js/bootstrap.js"></script>
    <script type="text/javascript" src="http://localhost:8888/laravel54/Public/home/js/widget-travel-index-nav.js"></script>
    <script>
    ...
    <script src="http://localhost:8888/laravel54/Public/home/js/page-learing-index.js"></script>
</body>